...
final class Version20250914163655 extends AbstractMigration
{
    ...
    {
        return 'Rename horse.current_location_id to stall_unit_id and normalize horse fields';
    }
    ...
    public function up(Schema $schema): void
    {
        if ($this->connection->getDatabasePlatform() instanceof SqlitePlatform) {
            ...
            $this->addSql('INSERT INTO horse (id, name, age, date_of_birth, breed, gender, special_notes, medical_history, medication, owner_id, stall_unit_id) SELECT id, name, 0, date_of_birth, "", gender, notes, medical_history, medication, owner_id, current_location_id FROM __temp_horse');
    ...
    public function down(Schema $schema): void
    {
        if ($this->connection->getDatabasePlatform() instanceof SqlitePlatform) {
            ...
            $this->addSql('INSERT INTO horse (id, name, notes, owner_id, medical_history, medication, gender, date_of_birth, current_location_id) SELECT id, name, special_notes, owner_id, medical_history, medication, gender, date_of_birth, stall_unit_id FROM __temp_horse');
            $this->addSql('DROP TABLE __temp_horse');
        } else {
